                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input name="name" type="text" class="form-control" placeholder="Event Name *" value="" required/>
                                        </div>
                                        <div class="form-group">
                                            <input name="date" type="date" class="form-control"  placeholder="Date *" value="" required />
                                        </div>
                                        <div class="form-group">
                                            <input name="instructor" type="text" class="form-control"  placeholder="Instructor *" value="" required />
                                        </div>
